...
const Footer = () => {
    return (
        <footer className="footer footer-center bg-[#0B0223] text-white p-10">
            ...
            <aside>
                <Link to={'/'} className={`text-2xl sm:text-3xl xl:text-4xl inline-flex items-center gap-2 font-bold`}>
                    <img src={logo} className="w-12 sm:w-16 xl:w-18" alt="" />
                    <span className="text-[#FF42A5]">Chill</span> Gamer</Link>
                ...
                <div className="grid grid-flow-col gap-4">
                    ...
                    <Link to={`https://x.com/?lang=en`}>
                        <svg
                            ...
                            viewBox="0 0 24 24"
                            className="fill-current w-6 sm:w-7 xl:w-8 h-6 sm:h-7 xl:h-8">
                            <path
